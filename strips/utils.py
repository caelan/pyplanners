...
def ha_all(state, goal, operators): return operators
def ha_applicable(state, goal, operators): return [operator for operator in operators if operator(state) is not None]
